...
import { GAZAKLAR } from "../../data/APIData";
...
const Gazak = () => {
  ...
  return (
    <div className="pb-12">
      <h1 className="mb-5 text-[28px] font-semibold leading-none">Gazaklar</h1>
        ...
        {maxi.map((food) => (
          ...
          >
            ...
            <div className="px-4 pb-4 pt-3">
              ...
              <div className="flex absolute right-4 left-4 bottom-4 items-center justify-between">
